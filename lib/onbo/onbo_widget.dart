...
import 'onbo_model.dart';
export 'onbo_model.dart';

class OnboWidget extends StatefulWidget {
  const OnboWidget({super.key});

  @override
  State<OnboWidget> createState() => _OnboWidgetState();
}

class _OnboWidgetState extends State<OnboWidget> with TickerProviderStateMixin {
  late OnboModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboModel());
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'acabas de entras a  la app de los revolucionarios ',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
